...
public class MagicTextView extends TextView {
	...
	public void setGradientBottomColor(int colorId) {
		this.gradientBottomColor = colorId;
	}
	
	public void setGradientTopColor(int colorId) {
		this.gradientTopColor = colorId;
	}
